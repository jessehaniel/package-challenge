...
class ConstraintsValidationTest {
    ...
    void validInputFormat() {
        String validInputLine = "81 : (1,53.38,€45) (2,88.62,€98) (3,78.48,€3) (4,72.30,€76) (5,30.18,€9) (6,46.34,"
            + "€48)";
        ConstraintsValidation.validateInputFormat(validInputLine);
    }
    
    @Test
    void whenMultipleBlankSpacesIsValidInputFormat() {
        String blankSpacesInputLine = "81 :    (1,53.38,€45)    (2,88.62,€98)  (3,78.48,€3)";
        ConstraintsValidation.validateInputFormat(blankSpacesInputLine);
    }
